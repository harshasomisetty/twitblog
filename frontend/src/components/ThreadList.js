          ...
          <Link to={`/thread/${thread["_id"]}`}>
            <div className="relative flex flex-row gap-2 h-80 rounded-lg border-2 border-gray-600 p-6 overflow-hidden">
              ...
              <div className="flex flex-col justify-between border-0 border-gray-700 h-full w-full">
                <div className="h-min flex flex-row justify-between items-end space-x-3 w-full text-center border-b leading-1 m-2 h-5 ">
                ...
                <p className="m-2 h-2/3 font-normal text-sm antialiased indent-8 text-ellipsis overflow-hidden">
                  {" "}
                  {thread.tweets[0][0]}
                </p>

                <div className="h-1/6 flex flex-col w-full h-12 text-left border-t m-2 ">
